...
<body>
    <div class="flex-center position-ref">
        ...
        <div class="top-right links">
            ...
            @else
            <a href="{{ url('/guestQualification') }}">Login</a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="table-responsive  mt-1" align="center" style="padding:20px;">
                            <table class="table select-table" border="1">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6><a href="{{ url('/guestQualification') }}">Click To Check Qualification</a></h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <br /><br />
                            <a href="{{ url('/') }}" type="button" style="padding:10px;background-color:cornflowerblue;">Back</a>
                        </div>
                    </div>
                </div>
            </div>
