                                    ...
                                    <div class="card card-rounded">
                                        <div class="card-body">
                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                <div>
                                                    <h4 class="card-title card-title-dash">Application Form</h4>
                                                </div>
                                                <br /><br />
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <form method="post" action="FormData" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <!-- <input id="semester" type="text" value="" class="form-control" name="semester"> -->
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input id="session" type="text" value="" class="form-control" name="session">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input id="name" type="text" value="" class="form-control" name="name">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="staff_matric_number">Staff / Matric Number</label>
                                                                <input id="staff_matric_number" type="text" value="" class="form-control" name="staff_matric_number">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="m_p">MyKad / Passport</label>
                                                                <input id="m_p" type="text" value="" class="form-control" name="m_p">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="p_address">Postal Address</label>
                                                                <input id="p_address" type="text" value="" class="form-control" name="p_address">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="fax">Fax</label>
                                                                <input id="fax" type="text" value="" class="form-control" name="fax">
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input id="m_status" type="text" value="" class="form-control" name="m_status">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="dob">Date Of Birth</label>
                                                                <input id="dob" type="date" value="" class="form-control" name="dob">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="tp_home">Telephone (Home)</label>
                                                                <input id="tp_home" type="text" value="" class="form-control" name="tp_home">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="tp_office">Telephone (Office)</label>
                                                                <input id="tp_office" type="text" value="" class="form-control" name="tp_office">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="tp_hp">Telephone (H/P)</label>
                                                                <input id="tp_hp" type="text" value="" class="form-control" name="tp_hp">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="eg_p">English Proficiency</label>
                                                                <select id="eg_p" value="" class="form-control" name="eg_p">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select id="gender" value="" class="form-control" name="gender">
                                                                    <option>Please Select</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input id="kdc" type="text" value="" class="form-control" name="kdc">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="nationality">Nationality</label>
                                                                <input id="nationality" type="text" value="" class="form-control" name="nationality">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="pp">Present Position (in IIUM or Outside. You may add attachment if necessary)</label>
                                                                <input id="pp" type="text" value="" class="form-control" name="pp">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <select id="apply" value="" class="form-control" name="apply">
                                                                    ...
                                                                    <option value="Parenting Lecturer">Parenting Lecturer</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input id="s_i_u_a_1" type="text" value="" class="form-control" name="s_i_u_a_1">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_from_1">Year From</label>
                                                                <input id="y_from_1" type="text" value="" class="form-control" name="y_from_1">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_until_1">Year Until</label>
                                                                <input id="y_until_1" type="text" value="" class="form-control" name="y_until_1">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="a_qualification_1">Academic Qualification 1</label>
                                                                <input id="a_qualification_1" type="text" value="" class="form-control" name="a_qualification_1">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="s_i_u_a_2">School/Institution/University Attended 2</label>
                                                                <input id="s_i_u_a_2" type="text" value="" class="form-control" name="s_i_u_a_2">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_from_2">Year From</label>
                                                                <input id="y_from_2" type="text" value="" class="form-control" name="y_from_2">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_until_2">Year Until</label>
                                                                <input id="y_until_2" type="text" value="" class="form-control" name="y_until_2">
                                                            </div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input id="s_i_u_a_3" type="text" value="" class="form-control" name="s_i_u_a_3">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_from_3">Year From</label>
                                                                <input id="y_from_3" type="text" value="" class="form-control" name="y_from_3">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_until_3">Year Until</label>
                                                                <input id="y_until_3" type="text" value="" class="form-control" name="y_until_3">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="a_qualification_3">Academic Qualification 3</label>
                                                                <input id="a_qualification_3" type="text" value="" class="form-control" name="a_qualification_3">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="s_i_u_a_4">School/Institution/University Attended 4</label>
                                                                <input id="s_i_u_a_4" type="text" value="" class="form-control" name="s_i_u_a_4">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_from_4">Year From</label>
                                                                <input id="y_from_4" type="text" value="" class="form-control" name="y_from_4">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label for="y_until_4">Year Until</label>
                                                                <input id="y_until_4" type="text" value="" class="form-control" name="y_until_4">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="a_qualification_4">Academic Qualification 4</label>
                                                                <input id="a_qualification_4" type="text" value="" class="form-control" name="a_qualification_4">
                                                            </div>
                                                        </div>
                                                        <br /> <br />
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input id="organisation_1" type="text" value="" class="form-control" name="organisation_1">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="position_1">Position</label>
                                                                <input id="position_1" type="text" value="" class="form-control" name="position_1">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="duration_1">Duration</label>
                                                                <input id="duration_1" type="text" value="" class="form-control" name="duration_1">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="organisation_2">Organisation 2</label>
                                                                <input id="organisation_2" type="text" value="" class="form-control" name="organisation_2">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="position_2">Position</label>
                                                                <input id="position_2" type="text" value="" class="form-control" name="position_2">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="duration_2">Duration</label>
                                                                <input id="duration_2" type="text" value="" class="form-control" name="duration_2">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="organisation_3">Organisation 3</label>
                                                                <input id="organisation_3" type="text" value="" class="form-control" name="organisation_3">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="position_3">Position</label>
                                                                <input id="position_3" type="text" value="" class="form-control" name="position_3">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="duration_3">Duration</label>
                                                                <input id="duration_3" type="text" value="" class="form-control" name="duration_3">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <label for="organisation_4">Organisation 4</label>
                                                                <input id="organisation_4" type="text" value="" class="form-control" name="organisation_4">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="position_4">Position</label>
                                                                <input id="position_4" type="text" value="" class="form-control" name="position_4">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="duration_4">Duration</label>
                                                                <input id="duration_4" type="text" value="" class="form-control" name="duration_4">
                                                            </div>
                                                        </div>
                                                        <br />
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input id="rew" type="text" value="" class="form-control" name="rew">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input id="wpp" type="text" value="" class="form-control" name="wpp">
                                                            </div>
                                                        </div>
                                                        <br />
                                                        <div class="divider"></div>
