    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/package') }}" class="btn btn-primary">Back To Package List</a>
                    <br /><br />
                    <h2>Qualification Required</h2>
                    <p>• Minimum 1st year 2nd semester, IIUM students with experience as facilitator/naqib.</p>
                    <p> • Completed Usrah Budi 1 (for undergraduate candidate).</p>
                    <p> • Able to recite Al-Quran with good Tajwid.</p>
                    <p> • Minimum CGPA 2.5</p>
                    <p> • Proficiency in English Language and ability to communicate effectively. Portray good attitude and show exemplary to others.</p>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="card card-rounded">
                                        <div class="card-body">
                                            <div class="d-sm-flex justify-content-between align-items-start">
                                                <div>
                                                    <h4 class="card-title card-title-dash">Qualification</h4>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12 grid-margin stretch-card">
                                                    <div class="card card-rounded">
                                                        <div class="card-body card-rounded">
                                                            ...
                                                            <a href="{{ url('/package') }}" class="btn btn-primary">Back To Package List</a>
                                                                <a href="applicationForm" type="button" class="btn btn-success">Apply Now</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
